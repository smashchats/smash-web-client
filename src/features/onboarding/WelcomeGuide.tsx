                ...
                <div className="welcome-content-wrapper">
                    ...
                    >
                        <div id="welcome-description" className="sr-only">
                            Welcome to Smashchats - A decentralized,
                            private-first messaging app
                        </div>
                        ...
                        <div className="welcome-header">
                            ...
                            <div className="welcome-steps">
                                <div
                                    className={`welcome-step ${step >= 1 ? 'welcome-step--active' : ''}`}
                                />
                                <div
                                    className={`welcome-step ${step >= 2 ? 'welcome-step--active' : ''}`}
                                />
                            </div>
                        </div>
