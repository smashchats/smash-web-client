...
const createMessage = (
    ...
    content,
    sender,
    timestamp: getRecentTimestamp(hoursAgo).getTime(),
    status,
});
...
export const mockConversations: SmashConversation[] = [
    {
        ...
        updatedAt: getRecentTimestamp(0.5).getTime(),
    },
    {
        id: 'conv2',
        title: 'Project Team',
        ...
        updatedAt: getRecentTimestamp(2).getTime(),
    },
    {
        id: 'conv3',
        title: 'Bob',
        ...
        updatedAt: getRecentTimestamp(4).getTime(),
    },
    {
        id: 'conv4',
        title: 'Design Team',
        ...
        updatedAt: getRecentTimestamp(6).getTime(),
    },
    {
        id: 'conv5',
        title: 'Charlie',
        ...
        updatedAt: getRecentTimestamp(12).getTime(),
    },
];
